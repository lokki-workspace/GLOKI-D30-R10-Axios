    ...
    <>
     <div className="edit-form">
        <div className="Title">
            ...
            {/* <FaUserPlus style={{ paddingBottom: "4px" , fontSize: "50px" , filter: "drop-shadow(1px 1px 20px yellow)"}} /> */}
        ...
        <Form>
            ...
            <div className="formGroup">
                <Form.Group className="mb-3" controlId="formGroupEmail">
                    ...
                    <InputGroup className="mb-3">
                        ...
                        <Form.Control placeholder="e.g: anna street" onChange={(e)=>{setStreet(e.target.value)}} aria-label="adress" aria-describedby="basic-addon1" />
                    </InputGroup>

                    <InputGroup className="mb-3">
                        <InputGroup.Text id="basic-addon1">Suite</InputGroup.Text>
                        <Form.Control placeholder="e.g: chepauk" onChange={(e)=>{setSuite(e.target.value)}} aria-label="adress" aria-describedby="basic-addon1" />
                    </InputGroup>

                    <InputGroup className="mb-3">
                        <InputGroup.Text id="basic-addon1">City</InputGroup.Text>
                        <Form.Control placeholder="e.g: chennai" onChange={(e)=>{setCity(e.target.value)}} aria-label="adress" aria-describedby="basic-addon1" />
                    </InputGroup>
            ...
            <div className="buttonGroup">
                <Button onClick={()=> handleAddUser()} variant="dark">
                    Submit
                </Button>
                &nbsp; &nbsp;
