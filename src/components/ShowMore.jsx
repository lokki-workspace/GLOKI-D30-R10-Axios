            ...
            <div className="showMoreContainer">
                <div className="showMoreCard">
                    ...
                    <div className="text-content">
                        <div className="textContent-center">
                        <p style={{textAlign: "center" , fontSize:"25px", color:"yellow"}}><b>USER PERSONAL DETAILS </b></p>
                        ...
                        <div className="textContent-left">
                            <p style={{textAlign: "center",fontSize:"25px", color:"yellow" }}><b>USER ADDRESS </b></p>
                        ...
                        <div className="textContent-right">
                            <p style={{textAlign: "center" , fontSize:"25px", color:"yellow"}}><b>USER COMPANY DETAILS</b></p>
